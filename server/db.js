...
const db = new Database(process.env.DB_PATH || join(dataDir, 'notepad.sqlite'));
...
db.exec(`
  ...
  -- One row per [[wiki link]] occurrence. Scoped to a notebook so that
  -- backlinks are NEVER shared across notebooks.
